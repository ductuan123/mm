...
class API_PRO5_NTK:
    def banner(self):
        os.system('title Tool Reg Page Profile Đa Luồng - Lê Quangg Minhh Official')
        os.system("cls" if os.name == "nt" else "clear")
        banner = '''
\033[1;34m╔════════════════════════════════════════════════════════════════╗
\033[1;34m║                                  \033[1;34m   ║\033[1;92m Admin: \033[1;97mLê Quang Minh \033[1;34m    ║
\033[1;34m║                                  \033[1;34m   ║\033[1;92m Momo: \033[1;93m0328774559    \033[1;34m     ║
\033[1;34m║            \033[1;97m █▀▄▀█ █ █▄░█ █░█     \033[1;34m   ║\033[1;92m MB Bank:\033[1;96m 9999190888888   \033[1;34m║
\033[1;34m║            \033[1;93m █░▀░█ █ █░▀█ █▀█     \033[1;34m   ║\033[1;92m MB Bank:\033[1;97m 1908888888889   \033[1;34m║
\033[1;34m║                                  \033[1;34m   ║\033[1;92m Zalo : \033[1;93m0328774559\033[1;34m        ║
\033[1;34m║                                  \033[1;34m   ║\033[1;92m Support: \033[1;95mLê Quang Minh   \033[1;34m║
\033[1;34m╚════════════════════════════════════════════════════════════════╝
\033[1;32m Tool Reg Page Profile Đa Luồng
\033[1;34m===========================================================================
\033[1;34m Bản Quyền: \033[1;33mLê Quang Minh (Mun)
\033[1;34m===========================================================================
        '''
        print(banner)
    def ntk_delaytool(self, p):
        ...
        while(p>1):
            p=p-1
            print(f'\033[1;36m[Lê Quangg Minhh Official][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[Lê Quangg Minhh Official][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[Lê Quangg Minhh Official][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[Lê Quangg Minhh Official][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[Lê Quangg Minhh Official][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'\033[1;36m[Lê Quangg Minhh Official][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
